    ...
    <section className="p-8" id="projects">
        ...
        <div className="columns-1 gap-4 md:columns-2 lg:columns-3">
            {PROJECTS.map((project)=>(
                <a key={project.id} className="block" href={project.link} target="_blank" rel="noopener noreferrer">
                    <div className="relative mb-4 overflow-hidden rounded-lg bg-white shadow-lg">
                        <img src={project.imgSrc} alt="project image" className="h-auto w-full object-cover" />
