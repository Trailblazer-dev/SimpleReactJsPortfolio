...
export const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A social media application with real-tieme chat and notifications.",
    imgSrc: project2,
  ...
  },
  {
    ...
    description:
      "An online learnng platform offering various courses and resources.",
    imgSrc: project6,
...
export const EXPERIENCES = [
  {
    ...
    description:
      "Developing and maitaining scalable web applications using modern technologies. Collaborating with cross-functional teams to design  and implement new features. Enhancing applications performance and ensuring high-quality code through rigorous testing and code reviews. Contributing to the continuous improvement of development processes  and best practices.",
  },
  {
    company: "Facebook",
